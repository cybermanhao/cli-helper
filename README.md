...
> 完整的可观测性/辅助端点见 [references/api-reference.md](references/api-reference.md) | SKILL.md
...
> 完整的 Dashboard 功能（含可观测性面板）见 [references/api-reference.md](references/api-reference.md) | SKILL.md
